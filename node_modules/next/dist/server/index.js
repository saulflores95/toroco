...
var Server = function () {
  function Server() {
    ...
    this.hotReloader = dev ? new _hotReloader2.default(this.dir, { quiet: quiet, conf: conf }) : null;
    this.http = null;
  ...
  (0, _createClass3.default)(Server, [{
              ...
              while (1) {
                switch (_context4.prev = _context4.next) {
                  case 0:
                    ...
                    p = (0, _path.join)(_this3.dir, '.next', 'chunks', params.name);
                    _context4.next = 4;
                    return _this3.serveStatic(req, res, p);
            ...
            return _regenerator2.default.wrap(function _callee5$(_context5) {
              while (1) {
                switch (_context5.prev = _context5.next) {
                  case 0:
                    p = (0, _path.join)(_this3.dir, '.next', 'chunks', params.id);
                    _context5.next = 3;
                    return _this3.serveStatic(req, res, p);
            ...
            return _regenerator2.default.wrap(function _callee11$(_context11) {
              while (1) {
                switch (_context11.prev = _context11.next) {
                  ...
                  case 19:
                    _context11.next = 21;
                    return _this3.getCompilationError(page, req, res);
          ...
          while (1) {
            switch (_context20.prev = _context20.next) {
              case 0:
                ...
                _context20.next = 3;
                return this.getCompilationError('/_error');
    ...
    value: function () {
      var _ref24 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee23(page, req, res) {
        var errors, id, p;
        return _regenerator2.default.wrap(function _callee23$(_context23) {
          while (1) {
            switch (_context23.prev = _context23.next) {
              ...
              case 7:
                id = (0, _path.join)(this.dir, this.dist, 'bundles', 'pages', page);
                p = (0, _resolve.resolveFromList)(id, errors.keys());
                ...
                return _context23.abrupt('return', errors.get(p)[0]);
      ...
      function getCompilationError(_x69, _x70, _x71) {
